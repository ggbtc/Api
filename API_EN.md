...
5.0 API related to announcement content 
-------------------

Site announcements related to the use of wordpress Open Source CMS ，the API address is currently used ：https://api.100ma.com/wp-json

Generally use the get request content of the axios，not integrated into the middle layer ，splicing the url when a request is made ：【API address】+【request interface?parameters(optional)】

There are **two methods of passing parameters** when making a get request，the following text with background color is the input parameter: 

1，With parameter name, question mark "?" To start,"&" concatenates multiple parameters,

​	/wp/v2/posts?categories=7&page=1

2，No parameter name, usually only one parameter, the default parameter name is the name of the upper 				  level interface ，/wp/v2/categories/&lt;id&gt;

Ex.：

Get interface to get a list of all articles in a category with id 7  ，

【url】=【https://api.100ma.com/wp-json】+【/wp/v2/posts?categories=7】

When there is no parameter, it acquires all by default. The following example acquires the list of all articles. 

【url】=【https://api.100ma.com/wp-json】+【/wp/v2/posts】

5.1 Get the category list 
----------------

- #### Gets a list of all categories 

#### interface：/wp/v2/categories

#### return value：An array of articles with a default length of 10

![](C:\Users\liuqi\Desktop\markdown\img1.png)

- #### Get category  for a specific id 

#### Interface：/wp/v2/categories/&lt;id&gt;

#### Return value：An array of articles with a default length of 10 

![](C:\Users\liuqi\Desktop\markdown\img2.png)

5.2 Get list of articles
----------------

- #### Get list of all articles

#### Interface：/wp/v2/posts

#### Return value: An array of articles with a default length of 10 ![](C:\Users\liuqi\Desktop\markdown\img3.png)

- #### Get  list of articles under a specific category 

#### Interface：/wp/v2/posts?categories=&lt;id&gt;
...
5.3 Get article content 
----------------

#### Interface：/wp/v2/posts/<id>

#### Return value：The article corresponding to the id 
